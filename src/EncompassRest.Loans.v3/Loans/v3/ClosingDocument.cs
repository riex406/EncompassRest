...
public sealed partial class ClosingDocument : DirtyExtensibleObject, IIdentifiable
{
    ...
    /// </summary>
    public string? AdditionalLienHolderAddressState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public decimal? AdditionalOriginalPrincipalAmountSecured { get => GetValue<decimal?>(); set => SetValue(value); }
    ...
    /// </summary>
    public DateTime? BorrowerTrustAmendedDateOrYear1 { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// Borrower Vesting Corp/Trust 2 Amended Date or Year [Vesting.Trst2AmdDate]
    /// </summary>
    public DateTime? BorrowerTrustAmendedDateOrYear2 { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// Closing Docs Borr 1 Org Trust Date or Year [2554]
    /// </summary>
    public DateTime? BorrowerTrustDateOrYear1 { get => GetValue<DateTime?>(); set => SetValue(value); }

    /// <summary>
    /// Borrower Vesting Corp/Trust 2 Date or Year [Vesting.Trst2Date]
    /// </summary>
    public DateTime? BorrowerTrustDateOrYear2 { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// Closing State [3542]
    /// </summary>
    public string? ClosingState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? DrawState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    [LoanFieldProperty(ReadOnly = true)]
    public decimal? IncludeSafeHarborDisclosure { get => GetValue<decimal?>(); set => SetValue(value); }
    ...
    /// </summary>
    [LoanFieldProperty(ReadOnly = true)]
    public DateTime? LastAuditDate { get => GetValue<DateTime?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? LienHolderAddressState { get => GetValue<string?>(); set => SetValue(value); }
    ...
    /// </summary>
    public string? MfgHomeManufacturerState { get => GetValue<string?>(); set => SetValue(value); }
